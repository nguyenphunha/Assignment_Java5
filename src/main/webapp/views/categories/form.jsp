...
<form:form action="/categories/category" modelAttribute="item">
    ...
    <button formaction="/categories/create">Create</button>
    <!-- Button to update a Category. When clicked, the form data will be sent to "/categories/update" -->
    <button formaction="/categories/update">Update</button>
    ...
    <a href="/categories/category" class="reset">Reset</a>
</form:form>
</body>
</html>
